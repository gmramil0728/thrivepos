                    ...
                    <div class="card-body p-4">
                        ...
                        <form method="post" action="{{ route('supplier.update') }}" enctype="multipart/form-data">
                            ...
                            <h5 class="mb-4 text-uppercase text-primary">
                                <i class="mdi mdi-account-edit-outline me-1"></i> Basic Information
                            </h5>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select name="type" class="form-select @error('type') is-invalid @enderror" id="type">
                                            ...
                                            <option value="Whole Seller" {{ old('type', $supplier->type) == 'Whole Seller' ? 'selected' : '' }}>Whole Seller</option> 
                                        </select>
                            ...
                            <div class="row align-items-center bg-light-subtle p-3 rounded-3 mx-0">
                                <div class="col-md-6">
                                    <div class="mb-0">
                                        <label for="image" class="form-label fw-bold text-dark">Update Supplier Photo</label>
                                        <input type="file" name="image" id="image" class="form-control @error('image') is-invalid @enderror">
                                        <small class="text-muted mt-1 d-block">Leave blank to keep current photo.</small>
                                ...
                                <div class="col-md-6 text-center">
                                    <div class="image-preview-wrapper mt-2 mt-md-0">
                                        <img id="showImage" src="{{ (!empty($supplier->image)) ? asset($supplier->image) : url('upload/no_image.jpg') }}" 
                            ...
                            <div class="text-end mt-4">
                                <a href="{{ route('supplier.all') }}" class="btn btn-light waves-effect me-2">Back</a>
                                <button type="submit" class="btn btn-primary waves-effect waves-light px-4">
                                    <i class="mdi mdi-content-save me-1"></i> Update Supplier
                                </button>
                            </div>
                        </form>
