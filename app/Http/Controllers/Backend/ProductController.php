    ...
    public function AllProduct(){
     ...
     public function StoreProduct(Request $request){ 
        ...
        $validateData = $request->validate([
            ...
            'product_code' => 'required|unique:products|max:200', 
            'category_id' => 'required|max:200',
            'supplier_id' => 'required|max:200',
            'inventory_count' => 'required|max:200',
            'buying_date' => 'required|max:200',
            'expire_date' => 'required|max:200',           
            'buying_price'  => 'required|numeric|min:0|max:9999999.99',
        ...
        public function UpdateProduct(Request $request)
        {
            ...
            $request->validate([
                ...
                'product_code'   => 'required|string|unique:products,product_code,' . $product_id,
                'category_id' => 'required|max:200',
                'supplier_id' => 'required|max:200',
                'inventory_count' => 'required|max:200',
                'buying_date' => 'required|max:200',
